...
const About = () => {
  ...
  return (
    <section className="bg-primary text-white px-5 py-8 -mt-4 -mb-4">
      <div className={`${styles.container} ${styles.grid} motion-safe:animate-fadeIn`}>
          ...
          <div className="about-text">
            ...
            <p className="text-white">
              ...
              ><em style={{ color: 'orange' }}>
                  <span className={`${styles.skillSpan} animate-pulse`}>
                    skills <i className="fa-solid fa-arrow-right"></i></span></em>
              </Link>
            </p>
          </div>
        </div>
